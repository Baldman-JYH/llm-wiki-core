...
| Codex user-level skill | Codex adapter | R4.1 complete | Provide explicit user-level skill install helpers | Opt-in only; does not mutate global config automatically |
| Codex plugin package | Codex adapter | Deferred | Keep as future target | Not marketplace-ready through R4.1 |
